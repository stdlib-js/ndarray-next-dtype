...
```
The previous example will load the latest bundled code from the umd branch. Alternatively, you may load a specific version by loading the file from one of the [tagged bundles](https://github.com/stdlib-js/ndarray-next-dtype/tags). For example,

```javascript
nextDataType = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/ndarray-next-dtype@v0.3.2-umd/browser.js' )
```
