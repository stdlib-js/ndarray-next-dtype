...
```javascript
import nextDataType from 'https://cdn.jsdelivr.net/gh/stdlib-js/ndarray-next-dtype@v0.2.0-deno/mod.js';
```
...
[test-image]: https://github.com/stdlib-js/ndarray-next-dtype/actions/workflows/test.yml/badge.svg?branch=v0.2.0
[test-url]: https://github.com/stdlib-js/ndarray-next-dtype/actions/workflows/test.yml?query=branch:v0.2.0
